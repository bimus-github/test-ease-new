...
import { LoadingSpinner } from "@/app/[telegram_id]/my-results/[submission_id]/components/LoadingSpinner";
import { DetailsSkeleton } from "@/app/[telegram_id]/my-results/[submission_id]/components/DetailsSkeleton";
import { RaschResultsCard } from "@/app/[telegram_id]/my-results/[submission_id]/components/RaschResultsCard";
  ...
  return (
    <main className="mx-auto w-full max-w-3xl p-4 sm:p-6">
      ...
      <section className="grid gap-4">
        ...
        <div className="rounded-md border border-neutral-200 p-2 shadow-sm dark:border-neutral-800 sm:p-4">
